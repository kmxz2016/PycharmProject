...
"""autogenerated by genpy from sixrobot_maintenance_msgs/TareEnable.msg. Do not edit."""
import sys
...
class TareEnable(genpy.Message):
  ...
  _type = "sixrobot_maintenance_msgs/TareEnable"
...
"""
  ...
  _slot_types = ['bool','string','sixrobot_maintenance_msgs/TareData']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.data is None:
        self.data = sixrobot_maintenance_msgs.msg.TareData()
    else:
      self.isEnabled = False
      self.uid = ''
      self.data = sixrobot_maintenance_msgs.msg.TareData()
