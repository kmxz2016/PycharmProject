...
"""autogenerated by genpy from sixrobot_core_msgs/NavigatorStates.msg. Do not edit."""
import sys
...
class NavigatorStates(genpy.Message):
  ...
  _type = "sixrobot_core_msgs/NavigatorStates"
...
"""
  ...
  _slot_types = ['string[]','sixrobot_core_msgs/NavigatorState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = sixrobot_core_msgs.msg.NavigatorState()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.button_names = []
