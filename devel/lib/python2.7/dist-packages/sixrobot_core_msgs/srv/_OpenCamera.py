...
"""autogenerated by genpy from sixrobot_core_msgs/OpenCameraRequest.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import sixrobot_core_msgs.msg

class OpenCameraRequest(genpy.Message):
  _md5sum = "c4194eee32741c5a98ef8da9666fa6c9"
  _type = "sixrobot_core_msgs/OpenCameraRequest"
...
"""
  ...
  _slot_types = ['string','sixrobot_core_msgs/CameraSettings']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.settings is None:
        self.settings = sixrobot_core_msgs.msg.CameraSettings()
    else:
      self.name = ''
      self.settings = sixrobot_core_msgs.msg.CameraSettings()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = sixrobot_core_msgs.msg.CameraControl()
        _x = val1
        start = end
        end += 8
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from sixrobot_core_msgs/OpenCameraResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class OpenCameraResponse(genpy.Message):
  ...
  _type = "sixrobot_core_msgs/OpenCameraResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class OpenCamera(object):
  _type          = 'sixrobot_core_msgs/OpenCamera'
