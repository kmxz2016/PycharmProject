// Generated by gencpp from file sixrobot_core_msgs/EndEffectorCommand.msg
// DO NOT EDIT!


#ifndef SIXROBOT_CORE_MSGS_MESSAGE_ENDEFFECTORCOMMAND_H
#define SIXROBOT_CORE_MSGS_MESSAGE_ENDEFFECTORCOMMAND_H
...
struct EndEffectorCommand_
{
  ...
  typedef boost::shared_ptr< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> const> ConstPtr;

}; // struct EndEffectorCommand_

typedef ::sixrobot_core_msgs::EndEffectorCommand_<std::allocator<void> > EndEffectorCommand;

typedef boost::shared_ptr< ::sixrobot_core_msgs::EndEffectorCommand > EndEffectorCommandPtr;
typedef boost::shared_ptr< ::sixrobot_core_msgs::EndEffectorCommand const> EndEffectorCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc003234e90416f2cULL;
  static const uint64_t static_value2 = 0xa02ac7837c42cbb7ULL;
};

template<class ContainerAllocator>
struct DataType< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sixrobot_core_msgs::EndEffectorCommand_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // SIXROBOT_CORE_MSGS_MESSAGE_ENDEFFECTORCOMMAND_H
