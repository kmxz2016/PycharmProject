// Generated by gencpp from file sixrobot_core_msgs/NavigatorState.msg
// DO NOT EDIT!


#ifndef SIXROBOT_CORE_MSGS_MESSAGE_NAVIGATORSTATE_H
#define SIXROBOT_CORE_MSGS_MESSAGE_NAVIGATORSTATE_H
...
struct NavigatorState_
{
  ...
  typedef boost::shared_ptr< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> const> ConstPtr;

}; // struct NavigatorState_

typedef ::sixrobot_core_msgs::NavigatorState_<std::allocator<void> > NavigatorState;

typedef boost::shared_ptr< ::sixrobot_core_msgs::NavigatorState > NavigatorStatePtr;
typedef boost::shared_ptr< ::sixrobot_core_msgs::NavigatorState const> NavigatorStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x680d121a1f16a326ULL;
  static const uint64_t static_value2 = 0x47298b292492fffdULL;
};

template<class ContainerAllocator>
struct DataType< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# buttons\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sixrobot_core_msgs::NavigatorState_<ContainerAllocator>& v)
  {
...
#endif // SIXROBOT_CORE_MSGS_MESSAGE_NAVIGATORSTATE_H
