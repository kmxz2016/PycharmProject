// Generated by gencpp from file sixrobot_core_msgs/SEAJointState.msg
// DO NOT EDIT!


#ifndef SIXROBOT_CORE_MSGS_MESSAGE_SEAJOINTSTATE_H
#define SIXROBOT_CORE_MSGS_MESSAGE_SEAJOINTSTATE_H
...
struct SEAJointState_
{
  ...
  typedef boost::shared_ptr< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> const> ConstPtr;

}; // struct SEAJointState_

typedef ::sixrobot_core_msgs::SEAJointState_<std::allocator<void> > SEAJointState;

typedef boost::shared_ptr< ::sixrobot_core_msgs::SEAJointState > SEAJointStatePtr;
typedef boost::shared_ptr< ::sixrobot_core_msgs::SEAJointState const> SEAJointStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd36406dcbb6d860bULL;
  static const uint64_t static_value2 = 0x1b39c4e28f81352bULL;
};

template<class ContainerAllocator>
struct DataType< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sixrobot_core_msgs::SEAJointState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SIXROBOT_CORE_MSGS_MESSAGE_SEAJOINTSTATE_H
