// Generated by gencpp from file sixrobot_core_msgs/AssemblyState.msg
// DO NOT EDIT!


#ifndef SIXROBOT_CORE_MSGS_MESSAGE_ASSEMBLYSTATE_H
#define SIXROBOT_CORE_MSGS_MESSAGE_ASSEMBLYSTATE_H
...
struct AssemblyState_
{
  ...
  typedef boost::shared_ptr< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> const> ConstPtr;

}; // struct AssemblyState_

typedef ::sixrobot_core_msgs::AssemblyState_<std::allocator<void> > AssemblyState;

typedef boost::shared_ptr< ::sixrobot_core_msgs::AssemblyState > AssemblyStatePtr;
typedef boost::shared_ptr< ::sixrobot_core_msgs::AssemblyState const> AssemblyStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x356d9dd237ce73b2ULL;
  static const uint64_t static_value2 = 0x667da9235f541933ULL;
};

template<class ContainerAllocator>
struct DataType< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sixrobot_core_msgs::AssemblyState_<ContainerAllocator>& v)
  {
    s << indent << "ready: ";
...
#endif // SIXROBOT_CORE_MSGS_MESSAGE_ASSEMBLYSTATE_H
