// Generated by gencpp from file sixrobot_core_msgs/RobustControllerStatus.msg
// DO NOT EDIT!


#ifndef SIXROBOT_CORE_MSGS_MESSAGE_ROBUSTCONTROLLERSTATUS_H
#define SIXROBOT_CORE_MSGS_MESSAGE_ROBUSTCONTROLLERSTATUS_H
...
struct RobustControllerStatus_
{
  ...
  typedef boost::shared_ptr< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> const> ConstPtr;

}; // struct RobustControllerStatus_

typedef ::sixrobot_core_msgs::RobustControllerStatus_<std::allocator<void> > RobustControllerStatus;

typedef boost::shared_ptr< ::sixrobot_core_msgs::RobustControllerStatus > RobustControllerStatusPtr;
typedef boost::shared_ptr< ::sixrobot_core_msgs::RobustControllerStatus const> RobustControllerStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2f15441b7285d915ULL;
  static const uint64_t static_value2 = 0xe7e59d3618e173f2ULL;
};

template<class ContainerAllocator>
struct DataType< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sixrobot_core_msgs::RobustControllerStatus_<ContainerAllocator>& v)
  {
    s << indent << "isEnabled: ";
...
#endif // SIXROBOT_CORE_MSGS_MESSAGE_ROBUSTCONTROLLERSTATUS_H
