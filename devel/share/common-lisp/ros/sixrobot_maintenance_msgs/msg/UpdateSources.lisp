...
(cl:defclass <UpdateSources> (roslisp-msg-protocol:ros-message)
  ((uuid
   ...
   (sources
    :reader sources
    :initarg :sources
    :type (cl:vector sixrobot_maintenance_msgs-msg:UpdateSource)
   :initform (cl:make-array 0 :element-type 'sixrobot_maintenance_msgs-msg:UpdateSource :initial-element (cl:make-instance 'sixrobot_maintenance_msgs-msg:UpdateSource))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <UpdateSources>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateSources)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_maintenance_msgs-msg:<UpdateSources> is deprecated: use sixrobot_maintenance_msgs-msg:UpdateSources instead.")))

(cl:ensure-generic-function 'uuid-val :lambda-list '(m))
(cl:defmethod uuid-val ((m <UpdateSources>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:uuid-val is deprecated.  Use sixrobot_maintenance_msgs-msg:uuid instead.")
  (uuid m))

(cl:ensure-generic-function 'sources-val :lambda-list '(m))
(cl:defmethod sources-val ((m <UpdateSources>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:sources-val is deprecated.  Use sixrobot_maintenance_msgs-msg:sources instead.")
  (sources m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <UpdateSources>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'sources)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sixrobot_maintenance_msgs-msg:UpdateSource))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateSources>)))
  ...
  "sixrobot_maintenance_msgs/UpdateSources")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateSources)))
  "Returns string type for a message object of type 'UpdateSources"
  "sixrobot_maintenance_msgs/UpdateSources")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UpdateSources>)))
  ...
  (cl:format cl:nil "string          uuid~%UpdateSource[]  sources~%~%================================================================================~%MSG: sixrobot_maintenance_msgs/UpdateSource~%string  devname~%string  filename~%string  version~%string  uuid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UpdateSources)))
  "Returns full string definition for message of type 'UpdateSources"
  (cl:format cl:nil "string          uuid~%UpdateSource[]  sources~%~%================================================================================~%MSG: sixrobot_maintenance_msgs/UpdateSource~%string  devname~%string  filename~%string  version~%string  uuid~%~%~%"))
