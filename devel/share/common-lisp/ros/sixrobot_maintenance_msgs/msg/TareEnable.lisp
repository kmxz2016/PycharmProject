...
(cl:defclass <TareEnable> (roslisp-msg-protocol:ros-message)
  ((isEnabled
   ...
   (data
    :reader data
    :initarg :data
    :type sixrobot_maintenance_msgs-msg:TareData
    :initform (cl:make-instance 'sixrobot_maintenance_msgs-msg:TareData)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TareEnable>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TareEnable)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_maintenance_msgs-msg:<TareEnable> is deprecated: use sixrobot_maintenance_msgs-msg:TareEnable instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TareEnable>)))
  ...
  "sixrobot_maintenance_msgs/TareEnable")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TareEnable)))
  "Returns string type for a message object of type 'TareEnable"
  "sixrobot_maintenance_msgs/TareEnable")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TareEnable>)))
  ...
  (cl:format cl:nil "bool isEnabled~%string uid~%TareData data~%~%================================================================================~%MSG: sixrobot_maintenance_msgs/TareData~%bool tuneGravitySpring~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TareEnable)))
  "Returns full string definition for message of type 'TareEnable"
  (cl:format cl:nil "bool isEnabled~%string uid~%TareData data~%~%================================================================================~%MSG: sixrobot_maintenance_msgs/TareData~%bool tuneGravitySpring~%~%~%"))
