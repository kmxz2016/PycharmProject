...
(cl:defmethod cl:initialize-instance :after ((m <CalibrateArmData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalibrateArmData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_maintenance_msgs-msg:<CalibrateArmData> is deprecated: use sixrobot_maintenance_msgs-msg:CalibrateArmData instead.")))

(cl:ensure-generic-function 'suppressWriteToFile-val :lambda-list '(m))
(cl:defmethod suppressWriteToFile-val ((m <CalibrateArmData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:suppressWriteToFile-val is deprecated.  Use sixrobot_maintenance_msgs-msg:suppressWriteToFile instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalibrateArmData>)))
  ...
  "sixrobot_maintenance_msgs/CalibrateArmData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalibrateArmData)))
  "Returns string type for a message object of type 'CalibrateArmData"
  "sixrobot_maintenance_msgs/CalibrateArmData")
