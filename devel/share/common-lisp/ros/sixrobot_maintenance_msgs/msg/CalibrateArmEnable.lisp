...
(cl:in-package sixrobot_maintenance_msgs-msg)
...
(cl:defclass <CalibrateArmEnable> (roslisp-msg-protocol:ros-message)
  ((isEnabled
   ...
   (data
    :reader data
    :initarg :data
    :type sixrobot_maintenance_msgs-msg:CalibrateArmData
    :initform (cl:make-instance 'sixrobot_maintenance_msgs-msg:CalibrateArmData)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CalibrateArmEnable>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalibrateArmEnable)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_maintenance_msgs-msg:<CalibrateArmEnable> is deprecated: use sixrobot_maintenance_msgs-msg:CalibrateArmEnable instead.")))

(cl:ensure-generic-function 'isEnabled-val :lambda-list '(m))
(cl:defmethod isEnabled-val ((m <CalibrateArmEnable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:isEnabled-val is deprecated.  Use sixrobot_maintenance_msgs-msg:isEnabled instead.")
  (isEnabled m))

(cl:ensure-generic-function 'uid-val :lambda-list '(m))
(cl:defmethod uid-val ((m <CalibrateArmEnable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:uid-val is deprecated.  Use sixrobot_maintenance_msgs-msg:uid instead.")
  (uid m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <CalibrateArmEnable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:data-val is deprecated.  Use sixrobot_maintenance_msgs-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalibrateArmEnable>)))
  ...
  "sixrobot_maintenance_msgs/CalibrateArmEnable")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalibrateArmEnable)))
  "Returns string type for a message object of type 'CalibrateArmEnable"
  "sixrobot_maintenance_msgs/CalibrateArmEnable")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CalibrateArmEnable>)))
  ...
  (cl:format cl:nil "bool isEnabled~%string uid~%CalibrateArmData data~%~%================================================================================~%MSG: sixrobot_maintenance_msgs/CalibrateArmData~%bool suppressWriteToFile~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CalibrateArmEnable)))
  "Returns full string definition for message of type 'CalibrateArmEnable"
  (cl:format cl:nil "bool isEnabled~%string uid~%CalibrateArmData data~%~%================================================================================~%MSG: sixrobot_maintenance_msgs/CalibrateArmData~%bool suppressWriteToFile~%~%~%"))
