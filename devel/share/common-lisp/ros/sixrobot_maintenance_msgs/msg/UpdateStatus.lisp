...
(cl:defmethod cl:initialize-instance :after ((m <UpdateStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_maintenance_msgs-msg:<UpdateStatus> is deprecated: use sixrobot_maintenance_msgs-msg:UpdateStatus instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <UpdateStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:status-val is deprecated.  Use sixrobot_maintenance_msgs-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'progress-val :lambda-list '(m))
(cl:defmethod progress-val ((m <UpdateStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:progress-val is deprecated.  Use sixrobot_maintenance_msgs-msg:progress instead.")
  (progress m))

(cl:ensure-generic-function 'long_description-val :lambda-list '(m))
(cl:defmethod long_description-val ((m <UpdateStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:long_description-val is deprecated.  Use sixrobot_maintenance_msgs-msg:long_description instead.")
  (long_description m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateStatus>)))
  ...
  "sixrobot_maintenance_msgs/UpdateStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateStatus)))
  "Returns string type for a message object of type 'UpdateStatus"
  "sixrobot_maintenance_msgs/UpdateStatus")
