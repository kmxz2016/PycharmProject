...
(cl:defmethod cl:initialize-instance :after ((m <TareData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TareData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_maintenance_msgs-msg:<TareData> is deprecated: use sixrobot_maintenance_msgs-msg:TareData instead.")))

(cl:ensure-generic-function 'tuneGravitySpring-val :lambda-list '(m))
(cl:defmethod tuneGravitySpring-val ((m <TareData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_maintenance_msgs-msg:tuneGravitySpring-val is deprecated.  Use sixrobot_maintenance_msgs-msg:tuneGravitySpring instead.")
  (tuneGravitySpring m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TareData>)))
  ...
  "sixrobot_maintenance_msgs/TareData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TareData)))
  "Returns string type for a message object of type 'TareData"
  "sixrobot_maintenance_msgs/TareData")
