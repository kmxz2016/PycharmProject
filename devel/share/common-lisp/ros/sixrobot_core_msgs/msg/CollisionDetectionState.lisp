...
(cl:defmethod cl:initialize-instance :after ((m <CollisionDetectionState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CollisionDetectionState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<CollisionDetectionState> is deprecated: use sixrobot_core_msgs-msg:CollisionDetectionState instead.")))
...
(cl:defmethod collision_state-val ((m <CollisionDetectionState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:collision_state-val is deprecated.  Use sixrobot_core_msgs-msg:collision_state instead.")
  (collision_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CollisionDetectionState>)))
  ...
  "sixrobot_core_msgs/CollisionDetectionState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CollisionDetectionState)))
  "Returns string type for a message object of type 'CollisionDetectionState"
  "sixrobot_core_msgs/CollisionDetectionState")
