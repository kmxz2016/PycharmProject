...
(cl:defmethod cl:initialize-instance :after ((m <EndpointState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<EndpointState> is deprecated: use sixrobot_core_msgs-msg:EndpointState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:header-val is deprecated.  Use sixrobot_core_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:pose-val is deprecated.  Use sixrobot_core_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:twist-val is deprecated.  Use sixrobot_core_msgs-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'wrench-val :lambda-list '(m))
(cl:defmethod wrench-val ((m <EndpointState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:wrench-val is deprecated.  Use sixrobot_core_msgs-msg:wrench instead.")
  (wrench m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EndpointState>)))
  ...
  "sixrobot_core_msgs/EndpointState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EndpointState)))
  "Returns string type for a message object of type 'EndpointState"
  "sixrobot_core_msgs/EndpointState")
