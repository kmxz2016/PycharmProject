...
(cl:defclass <AssemblyStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector sixrobot_core_msgs-msg:AssemblyState)
   :initform (cl:make-array 0 :element-type 'sixrobot_core_msgs-msg:AssemblyState :initial-element (cl:make-instance 'sixrobot_core_msgs-msg:AssemblyState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AssemblyStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssemblyStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<AssemblyStates> is deprecated: use sixrobot_core_msgs-msg:AssemblyStates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AssemblyStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sixrobot_core_msgs-msg:AssemblyState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AssemblyStates>)))
  ...
  "sixrobot_core_msgs/AssemblyStates")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AssemblyStates)))
  "Returns string type for a message object of type 'AssemblyStates"
  "sixrobot_core_msgs/AssemblyStates")
