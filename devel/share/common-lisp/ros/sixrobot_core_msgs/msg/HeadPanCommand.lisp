...
(cl:defmethod cl:initialize-instance :after ((m <HeadPanCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeadPanCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<HeadPanCommand> is deprecated: use sixrobot_core_msgs-msg:HeadPanCommand instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <HeadPanCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:target-val is deprecated.  Use sixrobot_core_msgs-msg:target instead.")
  (target m))

(cl:ensure-generic-function 'speed_ratio-val :lambda-list '(m))
(cl:defmethod speed_ratio-val ((m <HeadPanCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:speed_ratio-val is deprecated.  Use sixrobot_core_msgs-msg:speed_ratio instead.")
  (speed_ratio m))

(cl:ensure-generic-function 'enable_pan_request-val :lambda-list '(m))
(cl:defmethod enable_pan_request-val ((m <HeadPanCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:enable_pan_request-val is deprecated.  Use sixrobot_core_msgs-msg:enable_pan_request instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HeadPanCommand>)))
  ...
  "sixrobot_core_msgs/HeadPanCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HeadPanCommand)))
  "Returns string type for a message object of type 'HeadPanCommand"
  "sixrobot_core_msgs/HeadPanCommand")
