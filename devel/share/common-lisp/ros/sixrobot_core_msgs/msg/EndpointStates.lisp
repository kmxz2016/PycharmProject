...
(cl:defclass <EndpointStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector sixrobot_core_msgs-msg:EndpointState)
   :initform (cl:make-array 0 :element-type 'sixrobot_core_msgs-msg:EndpointState :initial-element (cl:make-instance 'sixrobot_core_msgs-msg:EndpointState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EndpointStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<EndpointStates> is deprecated: use sixrobot_core_msgs-msg:EndpointStates instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <EndpointStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:names-val is deprecated.  Use sixrobot_core_msgs-msg:names instead.")
  (names m))

(cl:ensure-generic-function 'states-val :lambda-list '(m))
(cl:defmethod states-val ((m <EndpointStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:states-val is deprecated.  Use sixrobot_core_msgs-msg:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EndpointStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sixrobot_core_msgs-msg:EndpointState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EndpointStates>)))
  ...
  "sixrobot_core_msgs/EndpointStates")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EndpointStates)))
  "Returns string type for a message object of type 'EndpointStates"
  "sixrobot_core_msgs/EndpointStates")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EndpointStates>)))
  ...
  "a0ca50a066809a5f065f39f37aa028fb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EndpointStates)))
  "Returns md5sum for a message object of type 'EndpointStates"
  "a0ca50a066809a5f065f39f37aa028fb")
