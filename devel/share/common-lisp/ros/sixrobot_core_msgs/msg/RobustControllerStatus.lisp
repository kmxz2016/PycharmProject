...
(cl:defmethod cl:initialize-instance :after ((m <RobustControllerStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobustControllerStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<RobustControllerStatus> is deprecated: use sixrobot_core_msgs-msg:RobustControllerStatus instead.")))

(cl:ensure-generic-function 'isEnabled-val :lambda-list '(m))
(cl:defmethod isEnabled-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:isEnabled-val is deprecated.  Use sixrobot_core_msgs-msg:isEnabled instead.")
  (isEnabled m))

(cl:ensure-generic-function 'complete-val :lambda-list '(m))
(cl:defmethod complete-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:complete-val is deprecated.  Use sixrobot_core_msgs-msg:complete instead.")
  (complete m))

(cl:ensure-generic-function 'controlUid-val :lambda-list '(m))
(cl:defmethod controlUid-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:controlUid-val is deprecated.  Use sixrobot_core_msgs-msg:controlUid instead.")
  (controlUid m))

(cl:ensure-generic-function 'timedOut-val :lambda-list '(m))
(cl:defmethod timedOut-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:timedOut-val is deprecated.  Use sixrobot_core_msgs-msg:timedOut instead.")
  (timedOut m))

(cl:ensure-generic-function 'errorCodes-val :lambda-list '(m))
(cl:defmethod errorCodes-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:errorCodes-val is deprecated.  Use sixrobot_core_msgs-msg:errorCodes instead.")
  (errorCodes m))

(cl:ensure-generic-function 'labels-val :lambda-list '(m))
(cl:defmethod labels-val ((m <RobustControllerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:labels-val is deprecated.  Use sixrobot_core_msgs-msg:labels instead.")
  (labels m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobustControllerStatus>)))
  ...
  "sixrobot_core_msgs/RobustControllerStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobustControllerStatus)))
  "Returns string type for a message object of type 'RobustControllerStatus"
  "sixrobot_core_msgs/RobustControllerStatus")
