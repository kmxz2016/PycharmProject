...
(cl:defmethod cl:initialize-instance :after ((m <AnalogIOState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnalogIOState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixrobot_core_msgs-msg:<AnalogIOState> is deprecated: use sixrobot_core_msgs-msg:AnalogIOState instead.")))
...
(cl:defmethod value-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:value-val is deprecated.  Use sixrobot_core_msgs-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'isInputOnly-val :lambda-list '(m))
(cl:defmethod isInputOnly-val ((m <AnalogIOState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixrobot_core_msgs-msg:isInputOnly-val is deprecated.  Use sixrobot_core_msgs-msg:isInputOnly instead.")
  (isInputOnly m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AnalogIOState>)))
  ...
  "sixrobot_core_msgs/AnalogIOState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnalogIOState)))
  "Returns string type for a message object of type 'AnalogIOState"
  "sixrobot_core_msgs/AnalogIOState")
