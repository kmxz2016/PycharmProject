...
// (in-package sixrobot_core_msgs.srv)
...
class SolvePositionIKRequest {
  ...
  static datatype() {
    ...
    return 'sixrobot_core_msgs/SolvePositionIKRequest';
  }
...
class SolvePositionIKResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'sixrobot_core_msgs/SolvePositionIKResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'sixrobot_core_msgs/SolvePositionIK'; }
};
