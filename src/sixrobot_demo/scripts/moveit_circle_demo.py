...
class MoveItCircleDemo:
    def __init__(self):
        ...
        target_pose.pose.position.x = -0.113843117714
        target_pose.pose.position.y = -0.263925535377
        target_pose.pose.position.z = 0.203809574202
        target_pose.pose.orientation.x = -0.5823369001931
        target_pose.pose.orientation.y = -0.396821528085
        target_pose.pose.orientation.z = -0.609736398369
        target_pose.pose.orientation.w = 0.36281942344
